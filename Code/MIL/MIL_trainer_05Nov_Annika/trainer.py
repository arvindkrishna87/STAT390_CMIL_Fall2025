...
self.scheduler = None
    ...
    def train(self, train_loader: DataLoader, val_loader: DataLoader, 
        ...
        self.scheduler = lr_scheduler.OneCycleLR(
            self.optimizer,
            max_lr=TRAINING_CONFIG.get("onecycle_max_lr", TRAINING_CONFIG["learning_rate"]),
            epochs=epochs,
            steps_per_epoch=steps_per_epoch,
            pct_start=TRAINING_CONFIG.get("onecycle_pct_start", 0.3),
            div_factor=TRAINING_CONFIG.get("onecycle_div_factor", 25.0),
